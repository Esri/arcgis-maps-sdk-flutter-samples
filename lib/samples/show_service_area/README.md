...
![Image of show service area](show_service_area.png)
...
* To add a barrier, tap the barrier button, and tap multiple locations on the map.
* To show service areas around facilities that were added, tap the service areas button.
...
7. Display the service area polygons as graphics in a `GraphicsOverlay` on the `ArcGISMapView`.
