...
![Image of Configure Scene Environment](configure_scene_environment.png)
...
3. Changes to the settings in the lighting controls manipulate the `SceneLighting` object in the `SceneEnvironment.lighting` property.
    ...
    * The “Direct Shadows” button sets the `areDirectShadowsEnabled` boolean property on the lightning object. This toggles the shadows cast by objects in the scene.
