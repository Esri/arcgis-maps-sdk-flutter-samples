...
![Image of apply raster rendering rule](apply_raster_rendering_rule.png)
...
5. Apply the rendering rule to the new raster using `imageServiceRaster.renderingRule = RenderingRule.withRenderingRuleInfo(renderingRuleInfo)`.
