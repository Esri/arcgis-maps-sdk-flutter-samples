...
![Image of list contents of KML file](list_contents_of_kml_file.png)
...
3. When a node is selected, use the node's extent to determine a viewpoint and set the `ArcGISSceneView` object's viewpoint to it.
