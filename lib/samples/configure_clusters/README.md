...
![Image of configure clusters](configure_clusters.png)
...
9. Configure a `onTap` event handler on the `MapView` to display feature cluster information in a `PopupView`.
