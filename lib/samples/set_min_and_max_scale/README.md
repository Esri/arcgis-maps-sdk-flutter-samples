...
![Image of set min and max scale](set_min_and_max_scale.png)
...
2. Set min and max scales of map with `maxScale` and `minScale` properties of `ArcGISMap`.
3. Set the map to an `ArcGISMapView` object.
