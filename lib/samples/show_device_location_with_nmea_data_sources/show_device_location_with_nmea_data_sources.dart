...
class _ShowDeviceLocationWithNmeaDataSourcesState
  ...
  _SimulatedNmeaDataSource? _nmeaDataSimulator;
  ...
  Future<void> _startDataSource() async {
    ...
    _nmeaDataSimulator ??= _SimulatedNmeaDataSource(nmeaSentences);
...
class _SimulatedNmeaDataSource {
  // Simulates timed groups of NMEA sentences for the location data source.
  _SimulatedNmeaDataSource(this.nmeaSentences)
