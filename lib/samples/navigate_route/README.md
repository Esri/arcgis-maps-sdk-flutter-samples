...
Click 'Navigate' to simulate traveling and to receive directions from a preset starting point to a preset destination. Click 'Reset' to start the simulation from the beginning.
