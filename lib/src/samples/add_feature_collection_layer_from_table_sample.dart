...
class AddFeatureCollectionLayerFromTableSample extends StatefulWidget {
  const AddFeatureCollectionLayerFromTableSample({
    super.key,
    required this.title,
  });
  final String title;
  ...
  @override
  AddFeatureCollectionLayerFromTableSampleState createState() =>
      AddFeatureCollectionLayerFromTableSampleState();
}

class AddFeatureCollectionLayerFromTableSampleState
